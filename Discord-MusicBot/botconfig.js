module.exports = {
  Admins: ["378578228031258635", "342675043727310848"], //Admins of the bot
  ExpressServer: true, //If you wanted to make the website run or not
  DefaultPrefix: process.env.Prefix || ">", //Default prefix, Server Admins can change the prefix
  Port: 3000, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/sbySMS7m3v", //Support Server Link
  Token: process.env.Token || "ODQ4MjcyMDYwNTg1MzQ1MDI0.GYhAtD.bVnoxibXBCIyARxG2c92gIRQP7GMwVb7GBNVyQ", //Discord Bot Token
  ClientID: process.env.Discord_ClientID || "930808367188934687", //Discord Client ID
